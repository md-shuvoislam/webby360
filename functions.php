<?php
/**
 * webby360 functions and definitions
 *
 ...
 */
function webby360_setup() {
	/*
		* Make theme available for translation.
		* Translations can be filed in the /languages/ directory.
		* If you're building a theme based on webby360, use a find and replace
		* to change 'webby360' to the name of your theme in all the template files.
		*/
	load_theme_textdomain( 'webby360', get_template_directory() . '/languages' );
	...
	add_theme_support(
		'custom-background',
		apply_filters(
			'webby360_custom_background_args',
			array(
...
add_action( 'after_setup_theme', 'webby360_setup' );
 ...
 */
function webby360_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'webby360_content_width', 640 );
}
add_action( 'after_setup_theme', 'webby360_content_width', 0 );
 ...
 */
function webby360_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'webby360' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'webby360' ),
...
add_action( 'widgets_init', 'webby360_widgets_init' );
...
add_action( 'wp_enqueue_scripts', 'webby360_scripts' );
